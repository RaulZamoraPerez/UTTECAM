        ...
        <div className="mb-12">
          {details.profileImage ? (
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-teal-500/10 to-blue-500/10 rounded-3xl blur-sm opacity-60 transition-opacity duration-500 pointer-events-none"></div>
              <img
                className="relative rounded-3xl w-full max-w-6xl mx-auto shadow-2xl border border-white/20"
                src={details.profileImage || "/placeholder.svg"}
            ...
            <div className="text-gray-500 italic text-center py-12">No hay imagen disponible</div>
          )}
        </div>
