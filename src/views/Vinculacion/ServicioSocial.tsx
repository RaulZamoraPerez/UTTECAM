...
interface ServicioSocialDocumento {
    ID: number;
    Nombre: string;
    Descripcion?: string;
...
interface Seccion {
    id: string;
    titulo: string;
    documentos: ServicioSocialDocumento[];
}
...
export default function ServicioSocial() {
    ...
    useEffect(() => {
        const fetchDocumentos = async () => {
            try {
                const response = await fetch(`${BACKEND_URL}/api/servicio-social`, {
                    headers: {
                ...
                const data: ServicioSocialDocumento[] = await response.json();
                setDocumentos(data);

                // Procesar secciones basadas en el Tipo
                const grupos: { [key: string]: ServicioSocialDocumento[] } = {};
                ...
                // Ordenar secciones si es necesario (ej. General al final o al principio)
    ...
    const descargarDocumento = (doc: ServicioSocialDocumento) => {
            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-700 max-w-2xl mx-auto">
                        Descarga los formatos, reglamentos y documentos necesarios para tu Servicio Social.
                    </p>
                </div>
