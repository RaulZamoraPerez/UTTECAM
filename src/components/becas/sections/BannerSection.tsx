        ...
        <>
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden relative">
                <div className="flex flex-col md:flex-row md:min-h-[500px]">
                    ...
                    <div className="p-6 md:p-8 md:w-3/5 flex flex-col justify-center relative z-10">
                        ...
                        {subtitle && (
                            <div className="inline-flex items-center gap-2 mb-3">
                                ...
                                <span className="text-xs font-bold text-[#0a9782] tracking-wider uppercase">
                                    {subtitle}
                                </span>
                            </div>
                        )}
                        ...
                        {description && (
                            <div className="prose text-gray-600 mb-6 leading-relaxed text-sm md:text-base">
                                {description.split('\n').map((line, i) => (
                        ...
                        {/* Nota al pie */}
                        {footerNote && (
                            <div className="flex items-start gap-2 text-xs text-gray-500 mt-auto pt-3 border-t border-gray-100">
                    ...
                    <div className="md:w-2/5  relative h-64 md:h-auto min-h-[300px] group flex items-center justify-center p-6 bg-gray-50">
                        {imageUrl ? (
                            <div className="relative w-full max-w-[320px] transform transition-transform duration-500 hover:scale-105">
                                <div
                                    className="relative rounded-2xl overflow-hidden shadow-2xl border-[6px] border-white bg-white w-full cursor-pointer"
