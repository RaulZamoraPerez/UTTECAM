            ...
            {pdfSeleccionado && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div className="relative bg-white w-full max-w-4xl max-h-[95vh] rounded-xl shadow-2xl border-2 border-gray-200 overflow-hidden">
                        <button
                            onClick={() => { setPdfSeleccionado(null); setDocumentoSeleccionado(null); }}
                            ...
                            {documentoSeleccionado?.facebookLink && (
                                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 border-t border-gray-200">
                                    <div className="text-center max-w-md mx-auto">
                                        ...
                                        <a href={documentoSeleccionado.facebookLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 font-semibold text-lg">
