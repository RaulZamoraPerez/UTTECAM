                                                        ...
                                                        <AnimatePresence>
                                                            {subItem.submenu && hoveredSubItem === subItem.label && (
                                                                <motion.div
                                                                    ...
                                                                    animate="visible"
                                                                    exit="exit"
                                                                    className={`absolute top-0 w-72 bg-white rounded-xl shadow-xl border border-gray-200 py-3 ${subMenuDirection === "right" ? "left-full ml-2" : "right-full mr-2"
                                                                        }`}
                                                                >
                                                    ...
                                                    <div key={subItem.label}>
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            {subItem.submenu && (
                                                                ...
                                                                >
                                                                    <ChevronRight
                                                                        className={`h-4 w-4 transition-transform duration-200 ${openMobileSubSubmenu === subItem.label ? "rotate-90" : ""
                                                                            }`}
                                                                    />
                                                                </button>
                                                            )}
