...
export const dataEnero2026 = [
    {
        ...
        documentos: [
            ...
            {
                id: "mant1",
                titulo: "Convocatoria Licenciatura en Lenguas Modernas o afín",
                archivo: "/Solicitud de publicación de convocatorias/Mantenimiento/Mantenimiento/Convocatoria.pdf",
            }
        ],
    },
];

export const dataSepDic2025 = {
    id: "seccion2",
