...
import FeriasProfesiograficas from "@/views/extensionUniversitaria/FeriasProfesiograficas/FeriasProfesiograficas";
import VisitasGuiadas from "@/views/extensionUniversitaria/VisitasGuiadas/VisitasGuiadas";
    ...
    <BrowserRouter basename="/">
      <Routes>
        <Route element={<AppLayout />}>
          ...
          <Route path="/ferias-profesiograficas" element={<FeriasProfesiograficas/>} />
